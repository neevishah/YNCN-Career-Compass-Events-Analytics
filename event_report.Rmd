...
Challenge! Finish this doc (remember to add in all our cool ass graphs + some analysis). Echo asks if we want to show what we are doing in R or no (supress output). Knit to export to PDF.
```{r echo=FALSE}
disc_breakdown
attendee_plot
